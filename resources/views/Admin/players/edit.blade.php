...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="card-body">
                    <div class="row justify-content-center">
                        <div class="col-md-12">
                            <form action="{{ route('admin.players.update', $players->id) }}" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="name" type="text" class="form-control"
                                        value="{{ old('name', $players->name) }}">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">born</label>
                                    <input name="born" type="text" class="form-control"
                                        value="{{ old('born', $players->born) }}">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="icc_ranking_bowling" type="text" class="form-control"
                                        value="{{ old('icc_ranking_bowling', $players->icc_ranking_bowling) }}">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">total_match</label>
                                    <input name="total_match" type="text" class="form-control"
                                        value="{{ old('total_match', $players->total_match) }}">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="_100s" type="text" class="form-control"
                                        value="{{ old('_100s', $players->_100s) }}">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">career_best_batting</label>
                                    <input name="career_best_batting" type="text" class="form-control"
                                        value="{{ old('career_best_batting', $players->career_best_batting) }}">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">wickets</label>
                                    <input name="wickets" type="text" class="form-control"
                                        value="{{ old('wickets', $players->wickets) }}">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">_5_wickets</label>
                                    <input name="_5_wickets" type="text" class="form-control"
                                        value="{{ old('_5_wickets', $players->_5_wickets) }}">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">economy</label>
                                    <input name="economy" type="text" class="form-control"
                                        value="{{ old('economy', $players->economy) }}">
                                </div>
                                <div class="form-group">
            ...
            <!-- /.container-fluid value="{{ old('team_id', $players->team_id) }}-->
